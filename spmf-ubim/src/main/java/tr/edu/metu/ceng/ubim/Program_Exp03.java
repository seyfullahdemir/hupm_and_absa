...
public class Program_Exp03 {
    ...
    public static void main(String[] args) {
        SqlConnectionHelper sqlConn = new SqlConnectionHelper("localhost", ABSAConstants.DB_NAME,
                "root", "123456");
        ResultSet resultSet = sqlConn.executeSelectQuery("select * from amazon_review_results where sentiment_score < 0 order by review_id");
...
*/
        ...
        try{
            ...
            PrintWriter writer = new PrintWriter("only_negative_transactions_exp03.txt", "UTF-8");
