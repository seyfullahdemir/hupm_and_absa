...
public class Transaction_Exp02 {
    private int id;
    ...
    public Transaction_Exp02(int id) {
        this.id = id;
        localUtilitiesPerItemMap = new HashMap();
    }

    public Transaction_Exp02(String transactionID) {
    ...
    public String toString() {
        ...
        for (Map.Entry<String, Utility> stringStringEntry : localUtilitiesPerItemMap.entrySet()) {
            ...
            ResultSet resultSet = sqlConn.executeSelectQuery("select id from aspect_exp02 where name = '" + key +"'");
